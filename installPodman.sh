...
echo "Install and configure for rootless podman"
...
echo "Update OS Params for Opensearch"
...
echo "Add docker.io to Registry"
echo 'unqualified-search-registries = ["docker.io"]' | sudo tee -a /etc/containers/registries.conf
pause 

echo "Enable linger for opc user processes"
sudo loginctl enable-linger $(whoami)
pause

echo "Configure profile for podman socket and aliases"
...
echo "Test if podman is running \n"
